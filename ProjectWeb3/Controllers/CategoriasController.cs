...
namespace ProjectWeb3.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Foto")] Categoria categoria, IFormFile Arquivo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Foto")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
